...
import althingi.data.CommitteMembership;
...
public abstract class _Committee extends BaseDataObject {
    ...
    public static final Property<List<CommitteMembership>> COMMITTEE_MEMBERSHIPS = Property.create("committeeMemberships", List.class);
    ...
    public long getFirstParliamentNumber() {
        ...
        if(this.firstParliamentNumber == null) {
            return 0;
        }
    ...
    public long getLastParliamentNumber() {
        ...
        if(this.lastParliamentNumber == null) {
            return 0;
        }
    ...
    public void addToCommitteeMemberships(CommitteMembership obj) {
        addToManyTarget("committeeMemberships", obj, true);
    }

    public void removeFromCommitteeMemberships(CommitteMembership obj) {
        removeToManyTarget("committeeMemberships", obj, true);
    }

    @SuppressWarnings("unchecked")
    public List<CommitteMembership> getCommitteeMemberships() {
        return (List<CommitteMembership>)readProperty("committeeMemberships");
    }
